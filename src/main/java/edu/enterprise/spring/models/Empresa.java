...
public class Empresa {
    ...
    @GeneratedValue(strategy = GenerationType.IDENTITY) //[9.B]. Asi decimos que cada empresa cuando se creé en la BD, lo haga de forma autoincremental de manera global, con Identity lo hago incremental pero por tabla.
    private int id;
